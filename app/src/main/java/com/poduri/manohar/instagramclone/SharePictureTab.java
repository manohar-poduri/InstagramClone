...
public class SharePictureTab extends Fragment implements View.OnClickListener{
            ...
            case R.id.btnShareImage:
                ...
                if (recievedImageBitmap != null){
                    ...
                    if (edtDescription.getText().toString().equals("")) {
                        FancyToast.makeText(getContext(),"ERROR:You must set a Description", Toast.LENGTH_LONG,FancyToast.ERROR,true).show();
    ...
    private void getChosenImage() {
       ...
       // FancyToast.makeText(getContext(),"Now we can success a images", Toast.LENGTH_LONG,FancyToast.SUCCESS,true).show();
